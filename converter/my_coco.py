...
class CocoDataset:
    ...
    def display_image(
        ...
        print("======")
        if image_id == "random":
            image_id = random.choice(list(self.images_by_id.keys()))
        ...
        # We may need to flip the channels
        if flip_channels:
            b, g, r = image.split()
    ...
    def process_images(self):
        ...
        for image in self.coco["images"]:
            ...
            if image_id in self.images_by_id:
                ...
                self.images_by_filename[image_file] = image
                self.filename_to_id[image_file] = image_id
